...
use DagaSmart\Erp\ErpServiceProvider;
use DagaSmart\Erp\Models\ErpPurchaseOrder;
...
class ErpPurchaseOrderService extends AdminService
{
    ...
    public function stateOption($isEdit = true, $userId = 0, $value = 0): array
    {
        $data = [];
    ...
    public function auditOption(): array
    {
        return [
            ['label' => '通过', 'value' => 1],
            ['label' => '不通过', 'value' => 1],
